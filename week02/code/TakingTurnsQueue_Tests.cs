...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue did not properly remove playes whose turns reached 0.
    ...
    // Defect(s) Found: newly added playes were inserted in the wrong order or queue rotation failed after insertion. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite-turn players (0 turns) were incorrectly decremented or removed from the queue.
    ...
    // Defect(s) Found: Negative and zero turn values meant to represent infinite turns were incorrectly handled.
